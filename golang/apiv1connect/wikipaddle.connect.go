...
const (
	...
	MobileName = "wikipaddle.api.v1.Mobile"
)
...
const (
	...
	MobileGetUserProcedure = "/wikipaddle.api.v1.Mobile/GetUser"
	// MobileGetGuideProcedure is the fully-qualified name of the Mobile's GetGuide RPC.
	MobileGetGuideProcedure = "/wikipaddle.api.v1.Mobile/GetGuide"
	// MobileGetGuidesCollectionProcedure is the fully-qualified name of the Mobile's
	// GetGuidesCollection RPC.
	MobileGetGuidesCollectionProcedure = "/wikipaddle.api.v1.Mobile/GetGuidesCollection"
	// MobileGetCurrentUserProcedure is the fully-qualified name of the Mobile's GetCurrentUser RPC.
	MobileGetCurrentUserProcedure = "/wikipaddle.api.v1.Mobile/GetCurrentUser"
	// MobileGetGuideCommentsCollectionProcedure is the fully-qualified name of the Mobile's
	// GetGuideCommentsCollection RPC.
	MobileGetGuideCommentsCollectionProcedure = "/wikipaddle.api.v1.Mobile/GetGuideCommentsCollection"
	// MobileCreateGuideCommentProcedure is the fully-qualified name of the Mobile's CreateGuideComment
	// RPC.
	MobileCreateGuideCommentProcedure = "/wikipaddle.api.v1.Mobile/CreateGuideComment"
)

// MobileClient is a client for the wikipaddle.api.v1.Mobile service.
...
// NewMobileClient constructs a client for the wikipaddle.api.v1.Mobile service. By default, it uses
...
// GetUser calls wikipaddle.api.v1.Mobile.GetUser.
...
// GetGuide calls wikipaddle.api.v1.Mobile.GetGuide.
...
// GetGuidesCollection calls wikipaddle.api.v1.Mobile.GetGuidesCollection.
...
// GetCurrentUser calls wikipaddle.api.v1.Mobile.GetCurrentUser.
...
// GetGuideCommentsCollection calls wikipaddle.api.v1.Mobile.GetGuideCommentsCollection.
...
// CreateGuideComment calls wikipaddle.api.v1.Mobile.CreateGuideComment.
...
// MobileHandler is an implementation of the wikipaddle.api.v1.Mobile service.
...
func NewMobileHandler(svc MobileHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/wikipaddle.api.v1.Mobile/", mux
}
...
func (UnimplementedMobileHandler) GetUser(context.Context, *connect_go.Request[go_wikipaddle.UserRequest]) (*connect_go.Response[go_wikipaddle.UserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.GetUser is not implemented"))
}
...
func (UnimplementedMobileHandler) GetGuide(context.Context, *connect_go.Request[go_wikipaddle.GuideRequest]) (*connect_go.Response[go_wikipaddle.GuideResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.GetGuide is not implemented"))
}
...
func (UnimplementedMobileHandler) GetGuidesCollection(context.Context, *connect_go.Request[go_wikipaddle.GetGuidesCollectionRequest]) (*connect_go.Response[go_wikipaddle.GetGuidesCollectionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.GetGuidesCollection is not implemented"))
}
...
func (UnimplementedMobileHandler) GetCurrentUser(context.Context, *connect_go.Request[go_wikipaddle.GetCurrentUserRequest]) (*connect_go.Response[go_wikipaddle.UserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.GetCurrentUser is not implemented"))
}
...
func (UnimplementedMobileHandler) GetGuideCommentsCollection(context.Context, *connect_go.Request[go_wikipaddle.GetGuideCommentsCollectionRequest]) (*connect_go.Response[go_wikipaddle.GetGuideCommentsCollectionResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.GetGuideCommentsCollection is not implemented"))
}
...
func (UnimplementedMobileHandler) CreateGuideComment(context.Context, *connect_go.Request[go_wikipaddle.CreateGuideCommentRequest]) (*connect_go.Response[go_wikipaddle.GuideComment], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("wikipaddle.api.v1.Mobile.CreateGuideComment is not implemented"))
}
